...
CREATE TABLE BusyBee (
	...
	FOREIGN KEY (orderNo) REFERENCES orderNo (Orderr),
...
CREATE TABLE Equipment(
	...
	usage VARCHAR (9) DEFAULT ‘NO’ 
		CHECK (VALUE IN (‘AVAILABLE’, ‘EMPTY’)),  
...
CREATE TABLE Orderr (
	orderNo INTEGER(5) NOT NULL,
	daysOkWork VARCHAR(14) NOT NULL 
		CHECK (VALUE IN (‘SU’, ‘MO’, ‘TU’, ‘WE’, ‘TH’, ‘FR’, ‘SA’),
	timeStart INTEGER(4) NOT NULL 
		CHECK (VALUE BETWEEN 0000 AND 2400),
	timefinish INTEGER (4) NOT NULL
		CHECK(VALUE BETWEEN 0000 AND 2400),
	staffNo INTEGER (5) NOT NULL,
	clientNo INTEGER(8) NOT NULL,    
	equipNo INTEGER(5) NOT NULL,      
...
FOREIGN KEY (clientNo) REFERENCES clientNo(Client),
FOREIGN KEY (equipNo) REFERENCES equipNo(Equipment)); 
					 INSERT INTO Orderr VALUES (132, ‘MO TU WE’, 0500, 0700, 01,31, 423);
					 INSERT INTO Orderr VALUES (133, ‘WE’, 1900, 2100, 02, 32, 424);
					 INSERT INTO Orderr VALUES (134, ‘TH FR’, 2000, 2200, 03, 33, 425);
					 INSERT INTO Orderr VALUES (135, ‘SU SA’, 1900, 2000, 04, 34, 426);
					 INSERT INTO Orderr VALUES (136, ‘MO’, 0530, 0730, 05, 35, 427);
